...
# CONFIG
# ========================
parser = argparse.ArgumentParser(description="Temporal SCMVC on PAMAP2 3 views with Local Contrastive Loss")
...
# Use only 3 IMU views: hand, chest, ankle
# Exclude heart rate view
...
for epoch in range(1, args.con_epochs + 1):
    ...
    if acc > best_acc:
        ...
        torch.save(model.state_dict(), "./models/pamap_temporal_3views_local_best.pth")
...
print("Best model saved to: ./models/pamap_temporal_3views_local_best.pth")